...
- Average retrieval latency: **0.5 ms**
- Average token reduction vs full source context: **81.8%**

| Case | Layer | Pass | Latency ms | Retrieved tokens | Token reduction | Missing / Error |
| --- | --- | --- | ---: | ---: | ---: | --- |
| E01 | short_term | PASS | 0.5 | 133 | 0.0% |  |
| E06 | semantic | FAIL | 0.0 | 0 | 100.0% | missing=Idempotency-Key, max-3-retries, exponential-backoff |
| E09 | long_term | FAIL | 1.1 | 0 | 100.0% | missing=LOTUS-88, Java, Spring Boot |
| E10 | short_term | PASS | 3.9 | 195 | 0.0% |  |
